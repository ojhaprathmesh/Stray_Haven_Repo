...
public class SplashActivity extends BaseActivity {
    ...
    private void startHomeActivity() {
        ...
        // Set a flag to tell AuthActivity it's coming from splash screen
        intent.putExtra("FROM_SPLASH", true);

        // Start the activity with our custom smooth animation
        startActivity(intent);
        // Apply our custom animations with smooth easing curve
        overridePendingTransition(R.anim.slide_in_right_smooth, R.anim.fade_out);
        finish();
    }
} 